...
import cityBack from '../Images/cityback.jpg';
import ferryBack from '../Images/ferryback.jpg';
import nightBack from '../Images/nightback.jpg';

const Carousel = () => {
  const images = [cityBack, ferryBack, nightBack];
